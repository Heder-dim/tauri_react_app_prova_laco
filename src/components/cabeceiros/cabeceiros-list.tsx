...
export interface Cabeceiro {
  ...
  nome: string;
  hc: number;
  /** Quem esse cabeceiro é no banco global — usado pela página pra saber quem já foi adicionado */
    ...
    <div className="rounded-2xl bg-white p-5 shadow-sm">
      ...
      {cabeceiros.length === 0 ? (
        <p className="py-6 text-center text-sm text-slate-400">
          Nenhum cabeceiro registrado nessa prova ainda.
        </p>
      ) : (
          ...
          {cabeceiros.map((cabeceiro) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-slate-900">{cabeceiro.nome}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  aria-label={`Remover ${cabeceiro.nome} dessa prova`}
